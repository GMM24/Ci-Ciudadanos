        ...
        <form action="agregar_nivel_acad" method="post">
            ...
            <div class="mb-3">
                <label for="txtNombre" class="form-label">Nombre</label>
                 <input type="text" class="form-control" id="txtNombre" name="txtNombre" placeholder="Ingrese  nombre del nivel academico" value="<?=$datos['nombre'];?>">
            </div>
            <div class="mb-3">
                <label for="txtDescripcion" class="form-label">Descripción</label>
                  <input type="text" class="form-control" name="txtDescripcion" id="txtDescripcion" placeholder="Ingrese una breve descripcion del nivlel academico" value="<?=$datos['descripcion'];?>">
            </div>
